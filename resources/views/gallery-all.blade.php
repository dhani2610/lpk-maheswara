...
<head>
    ...
    <style>
        ...
        .gallery-header { background: white; padding: 60px 0; border-bottom: 1px solid #eee; margin-bottom: 40px; }
        .gallery-item { border-radius: 15px; overflow: hidden; position: relative; height: 280px; cursor: pointer; }
...
<body>
    ...
    <div class="gallery-header text-center" style="margin-top:5%">
        <div class="container">
            <h1 class="fw-bold">Galeri Kegiatan</h1>
            <p class="text-muted">Dokumentasi pelatihan dan aktivitas di {{ $setting->site_name ?? 'LPK Maheswara' }}</p>
        </div>
    </div>
